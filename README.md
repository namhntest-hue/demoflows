...
- Settings FAB (góc phải dưới): đổi ngôn ngữ + đổi font. Bộ font thử (21/08/2026, thay Inter/Plus Jakarta Sans theo yêu cầu user): **Montserrat · Mona Sans · Quicksand · Mulish · Manrope · Lora** — Lora là mặt chữ bộ da Editorial·MR PORTER; Inter rời panel nhưng VẪN load ở `<head>` vì PDP6 dùng riêng (`.font-inter`); Jakarta bỏ hẳn khỏi link Google Fonts.
