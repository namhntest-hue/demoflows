...
- Settings FAB (góc phải dưới): đổi ngôn ngữ + đổi font. Bộ font thử (21/08/2026, 2 nhịp yêu cầu user — thay Inter/Jakarta bằng 4 font mới, rồi Inter trở lại thế chỗ Quicksand): **Montserrat · Mona Sans · Inter · Mulish · Manrope · Lora** — Lora là mặt chữ bộ da Editorial·MR PORTER, Inter kiêm mặt chữ riêng của PDP6 (`.font-inter`); Jakarta + Quicksand bỏ hẳn khỏi link Google Fonts.
